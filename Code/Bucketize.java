...
public class Bucketize{
	...
	public static ArrayList<Bucket> bucketize_new(Set<Kwp> kwps){
	...
	public static ArrayList<Bucket> bucketize(Window k_minus_1, Set<Kwp> kwps){
		ArrayList<Bucket> ret = bucketize_new(kwps);
